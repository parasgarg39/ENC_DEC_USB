...
def call_encryption(path):
    ...
    print("Encryption process completed in ", end = '')
...
def call_decryption(path):
    ...
    print("Decryption process completed in ", end='')
...
if __name__ == '__main__':
    ...
    print("Plug in Your USB to start")
...
#            driveConnected()
        ...
        if x:
            ...
            print(str(x[0]) + " Drive is Removed")
#            driveDisconnected()
